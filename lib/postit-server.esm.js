...
function attachSchema(router) {
    var routeschema = new RouteSchema(__assign(__assign({}, C__00awam_Repos_postit_postitServer_node_modules_koaRouteSchemaYapi), { prefix: 'v1', schemaOptions: yapiSchemaOptions }));
