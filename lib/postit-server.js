...
var schemaOptions = {
    ...
    schemaOptions: [
        ...
        },
        {
            route: "/docs",
            method: "POST",
            schema: { type: 'object', properties: { content: { type: 'string', title: 'content', minLength: 0, maxLength: 5000 }, type: { type: 'string', title: 'type', mock: { mock: '@string' }, 'minLength': 1, maxLength: 20, enum: ['example', 'hexo', 'weibo'] } }, required: ['content', 'type'] },
        }
    ],
};

function attachSchema(router) {
    var routeschema = RouteSchema(schemaOptions);
