...
var C__00awam_Repos_02_published_koaRouteSchemaYapi = {
...
function attachSchema(router) {
    var routeschema = new RouteSchema(__assign(__assign({}, C__00awam_Repos_02_published_koaRouteSchemaYapi), { prefix: 'v1', schemaOptions: yapiSchemaOptions }));
