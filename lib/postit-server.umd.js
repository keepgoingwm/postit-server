(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('koa'), require('path'), require('log4js')) :
	typeof define === 'function' && define.amd ? define(['exports', 'koa', 'path', 'log4js'], factory) :
	(global = global || self, factory(global.PostitServer = {}, global.Koa, global.path, global.log4js));
}(this, (function (exports, Koa, path, log4js) { 'use strict';
	    ...
	    if (thislogger.isLevelEnabled(level) || options.level === 'auto') {
	      ...
	      ctx.response.writeHead = function (code, headers) {
	        ...
	        if (options.level === 'auto') {
	          level = levels$1.INFO;
	          if (code >= 300) level = levels$1.WARN;
	          if (code >= 400) level = levels$1.ERROR;
	        } else {
	          level = levels$1.getLevel(options.level, levels$1.INFO);
	        }
	      };
	      ...
	      if (ctx.res.statusCode && options.level === 'auto') {
	        level = levels$1.INFO;
	        if (ctx.res.statusCode >= 300) level = levels$1.WARN;
	        if (ctx.res.statusCode >= 400) level = levels$1.ERROR;
	      }
	...
	var koaLogger = getKoaLogger;

	var C__00awam_Repos_postit_postitServer_node_modules_koaLog4 = createCommonjsModule(function (module, exports) {
	exports = module.exports = log4js;
	exports.koaLogger = koaLogger;
	});
	var C__00awam_Repos_postit_postitServer_node_modules_koaLog4_1 = C__00awam_Repos_postit_postitServer_node_modules_koaLog4.koaLogger;

	C__00awam_Repos_postit_postitServer_node_modules_koaLog4.configure(path.join(__dirname, '../../logger.config.json'));
